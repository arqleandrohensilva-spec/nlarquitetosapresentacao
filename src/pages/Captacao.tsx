...
const Captacao = () => {
  return (
    <main className="relative bg-background text-foreground overflow-x-hidden">
      ...
      {/* ============================================================
          03 · CORES — paleta de assinatura
          ============================================================ */}
      <section
        id="cores"
        className="relative min-h-screen px-6 md:px-16 lg:px-24 py-28"
        style={{ backgroundColor: "#0F0D0B", color: "#E8E4DF" }}
      >
        <div className="max-w-7xl mx-auto">
          <div
            className="flex items-baseline justify-between mb-16 pb-4 border-b"
          ...
          <div className="grid grid-cols-12 gap-x-12 gap-y-16 items-start">
            <div className="col-span-12 lg:col-span-5">
              <Editable
                ...
                style={{ color: "#E8E4DF" }}
              >
                Uma paleta que <em className="not-italic" style={{ color: "#C9A876" }}>envelhece bem.</em>
              </Editable>
              ...
              >
                Trabalhamos com tons terrosos, neutros profundos e acentos dourados.
                Cores que não cansam, não datam, e ganham profundidade com a luz
                e o tempo.
              </Editable>
            </div>
            ...
            <div className="col-span-12 lg:col-span-7">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-1">
                {[
                  { id: "noite", name: "Noite Profunda", hex: "#1A1816", color: "#1A1816" },
                  { id: "carvalho", name: "Carvalho", hex: "#4A3A2A", color: "#4A3A2A" },
                  { id: "champagne", name: "Champagne", hex: "#C9A876", color: "#C9A876" },
                  { id: "terracota", name: "Terracota Suave", hex: "#9C6B4F", color: "#9C6B4F" },
                  { id: "linho", name: "Linho Cru", hex: "#D9CDB8", color: "#D9CDB8" },
                  { id: "alabastro", name: "Alabastro", hex: "#E8E4DF", color: "#E8E4DF" },
                ].map((c, i) => (
                  <div key={c.id} className="group">
                    ...
                    <div className="pt-3 pb-2 px-1">
                      <span
                        className="font-mono-edit text-[9px] tracking-[0.25em]"
                        style={{ color: "rgba(232, 228, 223, 0.5)" }}
                      >
                        0{i + 1}
                      </span>
                      <Editable
                        id={`cap.cores.swatch.${c.id}.name`}
                        className="font-display text-base block mt-1"
                        style={{ color: "#E8E4DF" }}
                      >
                        {c.name}
                      </Editable>
                      <Editable
                        id={`cap.cores.swatch.${c.id}.hex`}
                        className="font-mono-edit text-[10px] tracking-[0.15em] block"
