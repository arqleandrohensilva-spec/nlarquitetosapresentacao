  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ fontSize: "10px", color: "#888", letterSpacing: "0.2em", textTransform: "uppercase" }}>
            NL Arquitetos
          </div>
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: "10px", color: "#888", letterSpacing: "0.2em", textTransform: "uppercase" }}>
        ...
        {[
          ...
          <div
            ...
            style={{
              ...
              alignItems: "baseline",
              padding: "2.5mm 0",
              borderBottom: i < arr.length - 1 ? "0.3px solid #f0ede8" : "none",
              width: "100%",
            }}
          >
        ...
        <div style={{ display: "flex", alignItems: "baseline", padding: "2.5mm 0", width: "100%" }}>
          <div
            style={{
              fontSize: "10px",
              color: "#3A3A3A",
        ...
        >
          <div style={{ fontSize: "8px", color: "#bbb", letterSpacing: "0.15em", textTransform: "uppercase" }}>
            NL Arquitetos · São José dos Campos, SP
          </div>
