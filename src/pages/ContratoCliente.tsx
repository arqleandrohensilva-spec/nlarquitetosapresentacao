      ...
      <div className="contrato-page max-w-[800px] mx-auto bg-white p-12 lg:p-20 shadow-xl overflow-hidden">
        ...
        <div className="space-y-8 text-xs leading-relaxed">
            ...
            <section>
                ...
                <p>5.3 Caso o CONTRATANTE solicite mais de 02 (duas) rodadas de revisão em uma mesma etapa, ou alterações que impliquem mudanças significativas no conceito arquitetônico previamente aprovado, tais modificações serão consideradas serviços adicionais, cobradas por hora técnica.</p>
