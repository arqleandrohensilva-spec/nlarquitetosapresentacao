  ...
  return (
    <main className="relative bg-background text-foreground overflow-x-hidden">
      ...
      <div className="fixed top-24 right-6 md:right-10 lg:right-12 z-50 flex items-center gap-4 bg-background/60 backdrop-blur-xl border border-primary/20 px-5 py-2.5 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4)] transition-all hover:border-primary/50 group overflow-hidden" data-pdf-hide>
        ...
        <span className="relative font-mono text-[9px] md:text-[10px] uppercase tracking-[0.25em] text-primary/90 font-medium">Trilha Residencial</span>
      ...
      <section id="capa" className="relative min-h-screen flex flex-col justify-end px-6 md:px-16 lg:px-24 py-20">
        ...
        <div className="relative z-10 max-w-4xl fade-up">
          <Editable id="proposta-arq.capa.eyebrow" className="eyebrow mb-8 inline-block">
            Carta Proposta · Confidencial
          </Editable>
          <Editable as="h1" id="proposta-arq.capa.title" multiline className="font-display text-5xl md:text-7xl lg:text-[7.5rem] leading-[0.95] text-foreground mb-8 text-balance">
            A decisão tomada
            <br />
            <em className="text-primary not-italic font-light">antes</em> da obra.
          </Editable>
          <div className="gold-line w-32 mb-8" />
          <Editable id="proposta-arq.capa.subtitle" multiline className="font-display italic text-xl md:text-2xl text-foreground/70 max-w-xl block">
            Projeto executivo com compatibilização técnica e validação antecipada — para que cada centímetro seja decidido no papel, não no canteiro.
          </Editable>
      ...
      <section id="manifesto" className="relative min-h-screen flex items-center px-6 md:px-16 lg:px-24 py-32">
        <div className="grid grid-cols-12 gap-8 w-full max-w-7xl mx-auto">
          <div className="col-span-12 md:col-span-3">
            ...
            <Editable id="proposta-arq.manifesto.eyebrow" className="eyebrow">Manifesto</Editable>
          </div>
          <div className="col-span-12 md:col-span-9">
            <Editable as="h2" id="proposta-arq.manifesto.title" multiline className="font-display text-4xl md:text-6xl lg:text-7xl leading-[1.05] mb-16 text-balance">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-4xl">
              <Editable id="proposta-arq.manifesto.p1" multiline as="p" className="font-display text-lg md:text-xl leading-relaxed text-foreground/80">
              ...
              <Editable id="proposta-arq.manifesto.p2" multiline as="p" className="font-display text-lg md:text-xl leading-relaxed text-foreground/80">
                Cada decisão tomada em projeto evita uma decisão custosa na obra. Não é opinião — é lógica construtiva. Quando você decide no canteiro, o material já foi comprado e o erro já virou custo.
              </Editable>
            </div>
            <div className="mt-20 pl-8 border-l border-primary/40 max-w-2xl">
              <Editable id="proposta-arq.manifesto.quote" multiline as="p" className="font-display italic text-2xl md:text-3xl text-primary/90 leading-snug">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex items-baseline justify-between mb-8 lg:mb-10 border-b border-border/60 pb-4">
            <div className="flex items-baseline gap-6">
              ...
              <Editable id="proposta-arq.apresentacao.eyebrow" className="eyebrow">Quem conduz</Editable>
            </div>
            <Editable id="proposta-arq.apresentacao.tag" className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground hidden md:block">
              Dois arquitetos · Um método
            </Editable>
          </div>
          <div className="grid grid-cols-12 gap-x-8 gap-y-10 items-start">
            <div className="col-span-12 lg:col-span-6">
              <Editable as="h2" id="proposta-arq.apresentacao.title" multiline className="font-display text-4xl md:text-5xl lg:text-6xl leading-[1.0] text-balance mb-6">
                A NL não é definida por quem assina —<br />
                <em className="text-primary not-italic">é definida pelo processo.</em>
              </Editable>
              <Editable id="proposta-arq.apresentacao.body" multiline as="p" className="font-display text-base lg:text-lg leading-relaxed text-foreground/75 max-w-xl">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-baseline justify-between mb-14 lg:mb-20 pb-4 border-b" style={{ borderColor: "rgba(139, 115, 85, 0.35)" }}>
            <div className="flex items-baseline gap-6">
              ...
              <Editable id="proposta-arq.diagnostico.eyebrow" className="font-mono-edit text-[10px] uppercase tracking-[0.3em]" style={{ color: "#8B7355", fontFamily: '"Courier New", monospace' }}>
                Diagnóstico · Preparado para
              </Editable>
            </div>
            <Editable id="proposta-arq.diagnostico.tag" className="font-mono-edit text-[10px] uppercase tracking-[0.3em] hidden md:block" style={{ color: "rgba(232, 228, 223, 0.55)" }}>
              Resposta · não catálogo
            </Editable>
          </div>
          <div className="grid grid-cols-12 gap-x-12 gap-y-12 items-start">
            <div className="col-span-12 lg:col-span-5">
              <Editable as="h2" id="proposta-arq.diagnostico.title" multiline className="font-display text-4xl md:text-5xl lg:text-6xl leading-[1.0] text-balance mb-8" style={{ color: "#E8E4DF" }}>
              ...
              <Editable as="p" id="proposta-arq.diagnostico.subtitle" multiline className="font-display italic text-lg md:text-xl leading-relaxed max-w-md" style={{ color: "rgba(232, 228, 223, 0.78)" }}>
            ...
            <div className="col-span-12 lg:col-span-7 lg:pl-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-0">
                {[
                  ...
                  { id: "projeto", label: "Projeto", value: params.tipo },
                  ...
                  <div key={field.id} className="py-6 border-b" style={{ borderColor: "rgba(139, 115, 85, 0.35)" }}>
                    ...
                    <Editable id={`proposta-arq.diagnostico.field.${field.id}.value`} multiline as="p" className="font-display text-xl md:text-2xl leading-snug" style={{ color: "#E8E4DF" }}>
                      {field.value}
                    </Editable>
                  </div>
                ))}
          ...
          <div className="mt-20 lg:mt-24 flex flex-col items-center">
            <div className="h-px w-16 mb-8" style={{ backgroundColor: "#8B7355" }} />
            <Editable as="p" id="proposta-arq.diagnostico.closing" multiline className="font-display italic text-lg md:text-xl text-center max-w-2xl leading-relaxed" style={{ color: "#8B7355" }}>
      ...
      <section id="case" className="relative">
        <div className="grid grid-cols-12 min-h-screen">
          <div className="col-span-12 lg:col-span-7 relative min-h-[60vh] lg:min-h-screen">
            <img src={propostaCaseCasa} alt="Casa Costas · residência NL Arquitetos · São José dos Campos" className="absolute inset-0 w-full h-full object-cover" loading="lazy" width={1920} height={1280} />
          ...
          <div className="col-span-12 lg:col-span-5 relative px-8 md:px-16 py-20 lg:py-32 flex flex-col justify-center">
            <div className="max-w-md">
              ...
              <Editable as="h2" id="proposta-arq.case.title" multiline className="font-display text-5xl md:text-6xl leading-[0.95] mb-2">
                Casa <em className="text-primary not-italic">Costas.</em>
              </Editable>
              <Editable id="proposta-arq.case.location" className="font-mono text-xs uppercase tracking-[0.3em] text-muted-foreground block mb-10">
                Residência · 300m² · São José dos Campos
              </Editable>
              <div className="gold-line w-16 mb-8" />
              <Editable id="proposta-arq.case.body" multiline as="p" className="font-display text-lg leading-relaxed text-foreground/80 mb-10">
                O pedido era claro: uma residência que equilibrasse presença e acolhimento. A fachada em concreto e madeira define o limite entre o público e o privado — sem abrir mão da luz. Cada detalhe, do revestimento ao recuo da garagem, foi validado em projeto antes de qualquer execução. O resultado é uma casa que funciona exatamente como foi decidido — antes da primeira escavação.
              </Editable>
              <div className="grid grid-cols-3 gap-3 sm:gap-6 border-t border-border/60 pt-8">
                <CaseStat id="proposta-arq.case.s1" value="04" label="Meses de projeto" />
                <CaseStat id="proposta-arq.case.s2" value="05" label="Disciplinas" />
                <CaseStat id="proposta-arq.case.s3" value="0" label="Retrabalho" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="interiores" className="relative px-6 md:px-16 lg:px-24 py-32">
        <div className="max-w-7xl mx-auto grid grid-cols-12 gap-8 items-center">
          <div className="col-span-12 lg:col-span-5 order-2 lg:order-1">
            ...
            <Editable id="proposta-arq.interiores.eyebrow" className="eyebrow mb-8 inline-block">Interiores · Camada do habitar</Editable>
            <Editable as="h2" id="proposta-arq.interiores.title" multiline className="font-display text-5xl md:text-6xl leading-[1.0] mb-10 text-balance">
              O interior é onde a <em className="text-primary not-italic">arquitetura</em> encontra a vida.
            </Editable>
            <Editable id="proposta-arq.interiores.body" multiline as="p" className="font-display text-lg leading-relaxed text-foreground/75 mb-10">
            ...
            <ul className="space-y-3 font-display text-foreground/80">
              {[
                ...
                <li key={i} className="flex gap-4 items-baseline border-b border-border/40 pb-3">
                  ...
                  <Editable id={`proposta-arq.interiores.item${i}`} className="flex-1">{txt}</Editable>
                </li>
              ))}
            </ul>
          </div>
          <div className="col-span-12 lg:col-span-7 order-1 lg:order-2 relative">
            ...
            <div className="absolute -bottom-4 -left-4 md:-left-8 bg-background border-l-2 border-primary px-5 py-3">
              <Editable id="proposta-arq.interiores.caption" className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-baseline justify-between mb-16 border-b border-border/60 pb-6">
            <div className="flex items-baseline gap-6">
              ...
              <Editable id="proposta-arq.portfolio.eyebrow" className="eyebrow">Portfólio · Sequência</Editable>
            </div>
            <Editable id="proposta-arq.portfolio.tag" className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground hidden md:block">
              Quatro fragmentos · Um método
            </Editable>
          </div>
          <Editable as="h2" id="proposta-arq.portfolio.title" multiline className="font-display text-5xl md:text-7xl leading-[1.0] mb-20 max-w-4xl text-balance">
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6">
            <figure className="col-span-12 md:col-span-5 row-span-2 group">
              <a href={propostaPortFachada} target="_blank" rel="noreferrer" className="block overflow-hidden">
                <div className="relative aspect-[3/4] overflow-hidden">
                  <img src={propostaPortFachada} alt="Residência · fachada · NL Arquitetos" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1500ms] group-hover:scale-105" loading="lazy" width={1080} height={1440} />
                </div>
              </a>
              <figcaption className="mt-4 flex items-baseline justify-between">
                <Editable id="proposta-arq.port.cap1" className="font-display italic text-foreground/80">Fachada residencial · São José dos Campos</Editable>
            ...
            <figure className="col-span-12 md:col-span-7 group">
              <a href={propostaPortLiving} target="_blank" rel="noreferrer" className="block overflow-hidden">
                <div className="relative aspect-[16/10] overflow-hidden">
                  <img src={propostaPortLiving} alt="Sala de estar · NL Arquitetos" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1500ms] group-hover:scale-105" loading="lazy" width={1920} height={1200} />
                </div>
              </a>
              <figcaption className="mt-4 flex items-baseline justify-between">
                <Editable id="proposta-arq.port.cap2" className="font-display italic text-foreground/80">Sala de estar · Iluminação cênica</Editable>
            ...
            <figure className="col-span-6 md:col-span-3 group">
              <a href={propostaPortLazer} target="_blank" rel="noreferrer" className="block overflow-hidden">
                <div className="relative aspect-[3/4] overflow-hidden">
                  <img src={propostaPortLazer} alt="Área de lazer · NL Arquitetos" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1500ms] group-hover:scale-105" loading="lazy" width={1080} height={1440} />
                </div>
              </a>
              <figcaption className="mt-4">
                <Editable id="proposta-arq.port.cap3" className="font-display italic text-foreground/80 text-sm">Área de lazer · Convivência e materialidade</Editable>
            ...
            <figure className="col-span-6 md:col-span-4 group">
              <a href={propostaPortSuite} target="_blank" rel="noreferrer" className="block overflow-hidden">
                <div className="relative aspect-[3/4] overflow-hidden">
                  <img src={propostaPortSuite} alt="Suíte · NL Arquitetos" className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1500ms] group-hover:scale-105" loading="lazy" width={1920} height={1200} />
                </div>
              </a>
              <figcaption className="mt-4">
                <Editable id="proposta-arq.port.cap4" className="font-display italic text-foreground/80 text-sm">Suíte · Conforto e precisão</Editable>
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="flex items-baseline justify-between mb-12 border-b border-border/60 pb-6">
            <div className="flex items-baseline gap-6">
              ...
              <Editable id="proposta-arq.etapas.eyebrow" className="eyebrow">Etapas · Do briefing à entrega</Editable>
            </div>
            <Editable id="proposta-arq.etapas.tag" className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground hidden md:block">
              Arquitetura → Interiores · Fluxo encadeado
            </Editable>
          </div>
          <div className="grid grid-cols-12 gap-8 mb-16">
            <Editable as="h2" id="proposta-arq.etapas.title" multiline className="col-span-12 lg:col-span-7 font-display text-5xl md:text-6xl lg:text-7xl leading-[1.0] text-balance">
              Do primeiro traço<br />
              <em className="text-primary not-italic">ao detalhe final.</em>
            </Editable>
            <Editable id="proposta-arq.etapas.intro" multiline as="p" className="col-span-12 lg:col-span-5 lg:pt-4 font-display text-lg text-foreground/70 leading-relaxed">
          ...
          <PhaseTimeline trackId="proposta-arq.arq" number="01" title="Arquitetura Residencial" duration="5 a 6 meses" phases={[
          ...
          <div className="my-20 flex items-center gap-6">
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-muted-foreground">Após aprovação da arquitetura</span>
            <span className="h-px flex-1 bg-border" />
          </div>
          <PhaseTimeline trackId="proposta-arq.int" number="02" title="Arquitetura de Interiores" duration="3 a 4 meses · após arquitetura" phases={[
      ...
      <section id="escopo" className="relative px-6 md:px-16 lg:px-24 py-32">
        <div className="max-w-7xl mx-auto grid grid-cols-12 gap-8">
          <div className="col-span-12 lg:col-span-5 lg:sticky lg:top-24 self-start">
            ...
            <Editable id="proposta-arq.escopo.eyebrow" className="eyebrow mb-8 inline-block">Escopo técnico · O que entregamos</Editable>
            <Editable as="h2" id="proposta-arq.escopo.title" multiline className="font-display text-5xl md:text-6xl leading-[1.0] mb-10 text-balance">
              Duas disciplinas. <em className="text-primary not-italic">Um só método.</em>
            </Editable>
            <Editable id="proposta-arq.escopo.body" multiline as="p" className="font-display text-lg leading-relaxed text-foreground/75 mb-10">
              Quatro cadernos coordenados pela NL — base documental para uma obra sem improviso, com cada componente identificado, localizado e quantificado. Mesma estrutura para Arquitetônico e Interiores.
            </Editable>
            <div className="relative aspect-[4/5] overflow-hidden hidden lg:block">
              <img src={scopeMaterials} alt="Mesa de trabalho com amostras de materiais e croquis" className="absolute inset-0 w-full h-full object-cover" loading="lazy" width={1400} height={1750} />
            </div>
          </div>
      ...
      <FullBleedBand src={bandBlueprint} alt="Detalhe de prancha técnica e instrumentos de desenho — projeto executivo NL Arquitetos" number="Intermezzo · 01" caption="Cada linha no papel é uma decisão que não precisará ser tomada na obra." align="left" height="short" />
        ...
        <div className="relative max-w-6xl mx-auto w-full">
          <div className="flex items-baseline justify-between mb-10 md:mb-14 border-b border-border/60 pb-5">
            <div className="flex items-baseline gap-6">
              ...
              <Editable id="proposta-arq.pilares.eyebrow" className="eyebrow">Nossos Pilares</Editable>
            </div>
            <Editable id="proposta-arq.pilares.tag" className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground hidden md:block">O que nos diferencia</Editable>
          </div>
          <Editable as="h2" id="proposta-arq.pilares.title" multiline className="font-display text-3xl md:text-5xl leading-[1.05] mb-10 md:mb-14 max-w-3xl text-balance">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 md:gap-y-12">
            {[
              ...
              { id: "compatibilizacao", num: "II", kicker: "Coordenação · Técnica", body: "Todas as disciplinas coordenadas em conjunto com engenheiros parceiros. O que chega à obra já foi revisado e validado.", quote: "Mostramos o erro no computador para não errar no cimento." },
              ...
              <article key={p.id} className="flex gap-5 md:gap-6">
                ...
                <div className="flex-1 border-l border-border pl-5 md:pl-6">
                  <Editable id={`proposta-arq.pilares.${p.id}.kicker`} className="font-mono text-[9px] uppercase tracking-[0.3em] text-muted-foreground block mb-2">{p.kicker}</Editable>
                  <Editable as="p" id={`proposta-arq.pilares.${p.id}.body`} multiline className="font-display text-foreground/75 text-lg leading-relaxed mb-3">{p.body}</Editable>
                  <Editable as="p" id={`proposta-arq.pilares.${p.id}.quote`} multiline className="font-display italic text-xl md:text-2xl text-primary leading-snug">"{p.quote}"</Editable>
                </div>
              </article>
            ))}
          </div>
          <Editable as="p" id="proposta-arq.pilares.closing" className="mt-12 md:mt-16 pt-6 border-t border-border/60 font-display italic text-xl md:text-2xl text-foreground/75 text-center">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="relative grid grid-cols-12 gap-8 items-start mb-24">
            <div className="col-span-12 md:col-span-7 relative z-10">
              <div className="flex items-baseline gap-6 mb-8">
                ...
                <Editable id="proposta-arq.crono.eyebrow" className="font-mono-edit text-[10px] uppercase tracking-[0.3em]">
                  <span style={{ color: "rgba(232, 228, 223, 0.5)" }}>Linha do tempo · Estimativa</span>
                </Editable>
              </div>
              <Editable as="h2" id="proposta-arq.crono.title" multiline className="font-display text-5xl md:text-7xl lg:text-8xl leading-[0.95] text-balance">
            ...
            <div className="col-span-12 md:col-span-5 relative">
              <div className="md:text-right">
                <div aria-hidden className="font-display leading-[0.85] select-none" style={{ fontSize: "clamp(8rem, 16vw, 16rem)", color: "#8B7355", opacity: 0.18, letterSpacing: "-0.05em" }}>180</div>
                  ...
                  <div key={s.num} className="grid grid-cols-12 gap-4 md:gap-8 items-center py-7 md:py-8 border-b" style={{ borderColor: "rgba(139, 115, 85, 0.3)" }}>
                    ...
                    <div className="col-span-10 md:col-span-5 order-last md:order-none">
                      <div className="relative w-full" style={{ height: "3px" }}>
                        ...
                        <div className="absolute" style={{ left: `calc(${offsetPct}% - 1px)`, top: "-4px", width: "2px", height: "11px", background: "rgba(139, 115, 85, 0.8)" }} />
                        <div className="absolute" style={{ left: `calc(${offsetPct + widthPct}% - 1px)`, top: "-4px", width: "2px", height: "11px", background: "#8B7355" }} />
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-12 gap-8 mt-20 pt-2">
            <div className="col-span-12 md:col-span-5">
              ...
              <Editable id="proposta-arq.crono.total" className="font-display leading-none block">
            ...
            <div className="col-span-12 md:col-span-7 md:pl-12 md:border-l flex items-end" style={{ borderColor: "rgba(139, 115, 85, 0.3)" }}>
              <Editable id="proposta-arq.crono.note" multiline as="p" className="font-display italic leading-relaxed text-primary text-[clamp(1rem,1.25vw,1.2rem)]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-12 gap-8 mb-20">
            <div className="col-span-12 md:col-span-3">
              ...
              <Editable id="proposta-arq.beneficios.eyebrow" className="eyebrow">Benefícios</Editable>
            </div>
            <div className="col-span-12 md:col-span-9">
              <Editable as="h2" id="proposta-arq.beneficios.title" multiline className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.0] text-balance">
                O que você <em className="text-primary not-italic">recebe</em> além das pranchas.
              </Editable>
            </div>
          </div>
          <div className="mb-16 md:mb-20 text-center">
            <Editable id="proposta-arq.beneficios.intro" as="p" className="font-display italic text-balance">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border">
            {[
              { t: "Segurança na obra", d: "Projeto compatibilizado evita decisões improvisadas no canteiro — e os custos imprevistos que vêm com elas." },
              { t: "Decisão antes da obra", d: "Cada disciplina validada em projeto. O que está na prancha é o que vai para o canteiro — sem surpresa." },
              { t: "Aproveitamento do terreno", d: "Estudo de implantação que extrai o melhor da topografia, insolação e ventos predominantes." },
              { t: "Valorização do imóvel", d: "Arquitetura assinada e bem documentada agrega valor patrimonial mensurável na revenda." },
              { t: "Conforto a longo prazo", d: "Decisões pensadas para 10, 20 anos: pé-direito, fluxos, iluminação natural e materiais que envelhecem bem." },
              { t: "Previsibilidade financeira", d: "Quantitativos precisos permitem orçamentos firmes — e protegem você de aditivos surpresa." },
            ].map((b, i) => <BenefitCard key={i} {...b} idx={i} />)}
          </div>
          <div className="mt-12 text-center">
            <Editable id="proposta-arq.beneficios.tags" className="font-mono-edit uppercase text-muted-foreground">
          ...
          <div className="mt-16 text-center">
            <Editable id="proposta-arq.beneficios.fechamento" as="p" className="font-display italic">
      ...
      <section id="investimento" className="relative px-6 md:px-16 lg:px-24 py-32 bg-surface/40">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <Editable as="h2" id="proposta-arq.investimento.title" multiline className="font-display text-5xl md:text-7xl leading-[1.0] mb-8 text-balance">
              Dois planos. <em className="text-primary not-italic">Um só método.</em>
            </Editable>
            <Editable id="proposta-arq.investimento.body" multiline as="p" className="font-display italic text-lg md:text-xl text-foreground/70">
          ...
          <div className="mt-12 border border-border/60 bg-background max-w-5xl mx-auto">
            <div className="px-8 py-6 border-b border-border/60">
              <Editable id="proposta-arq.invest.pay.label" className="font-mono text-[10px] uppercase tracking-[0.3em] text-primary/80 block">
                Condições de pagamento · Aplicáveis aos dois planos
              </Editable>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border/60">
              <PaymentTier id="proposta-arq.pay1" label="Entrada" value="30%" sub="Na assinatura do contrato" />
              <PaymentTier id="proposta-arq.pay2" label="Anteprojeto" value="40%" sub="Na aprovação do anteprojeto" />
              <PaymentTier id="proposta-arq.pay3" label="Executivo" value="30%" sub="Na entrega do executivo" />
            </div>
          </div>
          <Editable id="proposta-arq.invest.mapas.note" multiline as="p" className="font-mono text-[11px] text-muted-foreground text-center mt-8 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="mt-8 border border-primary/30 bg-primary/[0.03] px-8 py-8 flex flex-col md:flex-row gap-6 items-start max-w-5xl mx-auto">
            ...
            <div>
              <Editable id="proposta-arq.invest.guarantee.label" className="font-mono text-[10px] uppercase tracking-[0.3em] text-primary/80 block mb-2">Garantia técnica NL</Editable>
              <Editable id="proposta-arq.invest.guarantee.body" multiline as="p" className="font-display text-lg text-foreground/85 leading-relaxed">
          ...
          <Editable id="proposta-arq.invest.closing" multiline as="p" className="font-display italic text-2xl md:text-3xl text-primary text-center mt-16 max-w-3xl mx-auto leading-snug">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-12 gap-8 mb-20 items-end">
            <div className="col-span-12 md:col-span-7">
              ...
              <Editable id="proposta-arq.diferenciais.eyebrow" className="eyebrow mb-8 inline-block">Diferenciais · O que nos separa</Editable>
              <Editable as="h2" id="proposta-arq.diferenciais.title" multiline className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.0] text-balance">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16">
            {[
              { r: "I", t: "Duas disciplinas, um único processo", d: "Arquitetura e Interiores desenvolvidos em sequência pelo mesmo escritório. Sem ruído de comunicação entre equipes diferentes. O que foi decidido na arquitetura alimenta diretamente os interiores — sem retrabalho, sem interpretação." },
            ...
            ].map((d, i) => <DifferentialItem key={i} {...d} />)}
          </div>
          <Editable id="proposta-arq.diferenciais.closing" multiline as="p" className="font-display italic text-2xl md:text-3xl text-primary text-center mt-20 max-w-3xl mx-auto leading-snug">
      ...
      <section id="nota" className="relative px-6 md:px-16 lg:px-24 py-32 overflow-hidden" style={{ backgroundColor: "#1A1816" }}>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <Editable id="proposta-arq.nota.title" as="h2" className="font-display text-6xl md:text-7xl lg:text-8xl text-foreground leading-[1.05] text-balance">Nota.</Editable>
            <Editable id="proposta-arq.nota.subtitle" as="p" className="font-display italic text-xl md:text-2xl text-primary/90 mt-4 leading-snug">
          ...
          <div className="grid md:grid-cols-2 gap-px bg-primary/15 border border-primary/15">
            {[
              { id: "01", title: "Dados fornecidos pelo cliente", intro: "Para o desenvolvimento do projeto será fundamental que o cliente forneça:", items: ["Matrícula do imóvel", "Legislação do terreno junto ao condomínio", "Documentação de aprovações anteriores (se existirem)"] },
              { id: "02", title: "Serviços extras contratados pelo cliente", intro: "A contratação dos itens abaixo é responsabilidade do cliente e essencial para o início do projeto:", items: ["Levantamento topográfico", "Sondagem do lote", "ART/RRT dos projetos complementares"] },
              { id: "03", title: "Serviços não inclusos", intro: null, items: ["Estudo de Impacto de Vizinhança", "Licenças Ambientais", "Projeto e aprovação do Corpo de Bombeiros", "Responsabilidade técnica pela execução da obra", "Gestão de obra e contratação de mão de obra", "Compra de materiais e insumos", "Projetos complementares de estrutura (coordenados em parceria, não executados pela NL)"] },
              { id: "04", title: "Serviços inclusos", intro: null, items: [] as string[], groups: [
              ...
              <div key={block.id} className="relative p-10 md:p-12 group" style={{ backgroundColor: "#1A1816" }}>
                <div className="flex items-baseline gap-4 mb-6">
                  ...
                  <Editable as="h3" id={`proposta-arq.nota.${block.id}.t`} className="font-display text-2xl md:text-3xl text-foreground leading-tight">{block.title}</Editable>
                </div>
                {block.intro && (
                  <Editable id={`proposta-arq.nota.${block.id}.intro`} multiline as="p" className="font-display text-foreground/70 leading-relaxed mb-5">{block.intro}</Editable>
                )}
                  ...
                  <ul className="space-y-2.5">
                    {block.items.map((item, i) => (
                      <li key={i} className="flex gap-3 text-sm md:text-base text-foreground/70 leading-relaxed">
                        ...
                        <Editable id={`proposta-arq.nota.${block.id}.item.${i}`} as="span" className="font-display flex-1">{item}</Editable>
                      </li>
                    ))}
                  </ul>
                )}
                      ...
                      <div key={gi}>
                        ...
                        <ul className="space-y-2.5">
                          {group.items.map((item, i) => (
                            <li key={i} className="flex gap-3 text-sm md:text-base text-foreground/70 leading-relaxed">
                              <span className="text-primary mt-1.5 text-[8px]">✦</span>
                              <Editable id={`proposta-arq.nota.${block.id}.${gi}.item.${i}`} as="span" className="font-display flex-1">{item}</Editable>
                            </li>
                          ))}
                        </ul>
                      </div>
          ...
          <Editable id="proposta-arq.nota.closing" multiline as="p" className="font-display italic text-2xl md:text-3xl text-primary text-center mt-20 max-w-3xl mx-auto leading-snug">
      ...
      <section id="proximos" className="relative px-6 md:px-16 lg:px-24 py-40 bg-gradient-to-b from-surface/60 via-background to-background overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-24">
            ...
            <Editable id="proposta-arq.proximos.eyebrow" className="eyebrow mb-8 inline-block">Próximos passos</Editable>
            <Editable as="h2" id="proposta-arq.proximos.title" multiline className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.0] mb-8 text-balance max-w-4xl mx-auto">
              Quatro passos. <em className="text-primary not-italic">Sete dias</em><br />até o primeiro traço.
            </Editable>
            <Editable id="proposta-arq.proximos.intro" multiline as="p" className="font-display italic text-xl md:text-2xl text-foreground/70 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="space-y-20 md:space-y-28">
              {[
                ...
                { n: "03", timing: "Em até 5 dias", t: "Reunião de imersão", d: "Encontro de até 3 horas, agendado em até 5 dias. Aqui ouvimos tudo — terreno, família, modo de viver." },
          ...
          <div className="mt-32 max-w-4xl mx-auto">
            <div className="border border-primary/30 bg-surface/60 px-8 md:px-16 py-16 md:py-20 relative">
              ...
              <Editable id="proposta-arq.proximos.cta.text" multiline as="p" className="font-display italic text-3xl md:text-4xl text-foreground text-center leading-tight max-w-2xl mx-auto mb-10">
              ...
              <Editable id="proposta-arq.proximos.cta.note" className="font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground text-center block mt-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="border-t border-border pt-16">
            <div className="grid grid-cols-12 gap-8">
              <div className="col-span-12 md:col-span-3">
                <Editable id="proposta-arq.cond.eyebrow" className="eyebrow">Condições gerais</Editable>
              </div>
              <div className="col-span-12 md:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 min-w-0">
                <Condition id="proposta-arq.c1" label="Prazo total" value="Até 14 semanas para escopo integral, divididas em entregas parciais aprovadas." />
                <Condition id="proposta-arq.c2" label="Revisões" value="Duas rodadas de revisão inclusas em cada etapa. Adicionais cobrados por hora técnica." />
                <Condition id="proposta-arq.c3" label="Forma de pagamento" value="PIX, transferência ou cartão. Boleto sob demanda." />
                <Condition id="proposta-arq.c4" label="Validade da proposta" value="30 dias corridos a partir da data desta carta. Após esse prazo, valores podem ser revisados." />
                <Condition id="proposta-arq.c5" label="Acompanhamento de obra" value="Não incluso no escopo padrão. Pode ser contratado à parte por visita ou pacote mensal." />
                <Condition id="proposta-arq.c6" label="Direitos autorais" value="O projeto é de autoria intelectual da NL Arquitetos, conforme Lei nº 9.610/98." />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="encerramento" className="relative min-h-screen flex items-center px-6 md:px-16 lg:px-24 py-32 overflow-hidden" style={{ backgroundColor: "#1A1816", color: "#E8E4DF" }}>
        ...
        <div className="relative max-w-5xl mx-auto w-full">
          ...
          <Editable as="h2" id="proposta-arq.encerramento.title" multiline className="font-display text-5xl md:text-7xl lg:text-8xl text-center leading-[1.0] mb-12 text-balance">
            <span style={{ color: "#E8E4DF" }}>A casa que você imagina</span><br />
            <em className="not-italic" style={{ color: "#8B7355" }}>já existe.</em>{" "}
            <span style={{ color: "#E8E4DF" }}>Falta começar.</span>
          </Editable>
          <Editable id="proposta-arq.encerramento.body" multiline as="p" className="font-display italic text-center max-w-2xl mx-auto mb-24 leading-relaxed text-[clamp(1.125rem,1.4vw,1.5rem)]" style={{ color: "#8B7355" }}>
            Agradecemos seu tempo e interesse.<br />Estamos à disposição para transformar suas ideias em realidade.
          </Editable>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 max-w-3xl mx-auto border-t" style={{ borderColor: "rgba(139, 115, 85, 0.3)" }}>
            <Contact id="proposta-arq.ct1" label="WhatsApp" value="(12) 99623-5559" />
            <Contact id="proposta-arq.ct2" label="E-mail" value="contato.nlarquitetos@gmail.com" />
            <Contact id="proposta-arq.ct3" label="Instagram" value="@nlarquitetos" />
          </div>
          <div className="mt-24 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-center md:text-left">
            <span className="font-display italic" style={{ color: "rgba(232, 228, 223, 0.6)" }}>"A arquitetura como decisão."</span>
            <span className="font-mono text-[9px] md:text-[10px] uppercase tracking-[0.2em] md:tracking-[0.3em] break-words" style={{ color: "rgba(139, 115, 85, 0.8)" }}>NL Arquitetos · 2025</span>
          </div>
        </div>
      </section>
